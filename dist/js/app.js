(() => {
    ...
    document.querySelector(".top-head").style.transition = "transform 0.3s, height 0.3s";
    ...
    function handleScrollAnimations() {
        ...
        animatedElements.forEach((element => {
            if (isElementInViewport(element)) element.classList.add("show"); else element.classList.remove("show");
        }));
    }
    ...
    function addMenuActive() {
        ...
        menuItems.forEach((item => {
            ...
            if (lastPart === dataMenuValue) item.classList.add("ac-link");
        }));
    }
    addMenuActive();
    window["FLS"] = true;
